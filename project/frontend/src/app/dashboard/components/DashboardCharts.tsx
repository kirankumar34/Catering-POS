    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 rounded-2xl border border-slate-800/60 bg-slate-950/40 p-6 backdrop-blur-xl shadow-lg">
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 mb-6">
          <div>
            <h3 className="text-lg font-bold text-white font-outfit">Financial Summary</h3>
            <p className="text-xs text-slate-400">Monthly breakdown of revenue, expenses, and net profit</p>
          </div>
        </div>
      ...
      <div className="rounded-2xl border border-slate-800/60 bg-slate-950/40 p-6 backdrop-blur-xl shadow-lg">
        <div className="mb-6">
          <h3 className="text-lg font-bold text-white font-outfit">Order Volume</h3>
          <p className="text-xs text-slate-400">Total catering bookings processed monthly</p>
        </div>
